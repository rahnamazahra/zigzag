                                ...
                                <td class="border px-4 py-2 relative">
                                    <div class="sm:ml-6 mr-4">
                                        <x-dropdown align="right" width="48">
                                            ...
                                            <x-slot name="content">
                                                <x-dropdown-link :href="route('orders.show', ['order' => $order])">
                                                    {{ __('messages.Detail') }}
                                                </x-dropdown-link>
                                                ...
                                                <x-dropdown-link :href="route('sizes.edit', ['order' => $order])">
                                                    {{ __('messages.Edit') }} {{ __('messages.Sizes') }}
                                                </x-dropdown-link>

                                                <x-dropdown-link :href="route('payments.show', ['order' => $order])">
