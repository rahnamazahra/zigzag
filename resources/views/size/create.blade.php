        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-8">
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight">  {{ __('messages.Create Size Order for') }} {{$order->customer->name}} </h2>
                    </div>
                    <form method="POST" action="{{ route('sizes.store') }}" class="mt-8">
                        @csrf
